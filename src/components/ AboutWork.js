    ...
    return (
        <div className="about-work__container">
            ...
            <div className="about-work__container--links">
                <a href="#">Fundacjom</a>
                <a href="#" style={{display: "flex", flexDirection: "column"}}><span>Organizacjom</span>
                    <span>pozarządowym</span></a>
                <a href="#" style={{display: "flex", flexDirection: "column"}}><span>Lokalnym</span>
                    <span>zbiórkom</span></a>
            </div>
